        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                ...
                case EVENT_BETRAYAL_4:
                    Talk(SAY_DRAKURU_5);
                    events.ScheduleEvent(EVENT_BETRAYAL_5, 3000);
                    break;
                case EVENT_BETRAYAL_5:
                    Talk(SAY_DRAKURU_6);
                    me->CastSpell(me, SPELL_THROW_PORTAL_CRYSTAL, true);
                    events.ScheduleEvent(EVENT_BETRAYAL_6, 6000);
                    break;
                case EVENT_BETRAYAL_6:
                {
                    if (TempSummon* ts = me->SummonCreature(NPC_LICH_KING, 6142.9f, -2011.6f, 590.86f, 0.0f, TEMPSUMMON_TIMED_DESPAWN, 42000))
                    {
                ...
                case EVENT_BETRAYAL_7:
                    ...
                    Talk(SAY_DRAKURU_7);
                    events.ScheduleEvent(EVENT_BETRAYAL_8, 7000);
                    break;
                ...
                case EVENT_BETRAYAL_11:
                    ...
                    events.ScheduleEvent(EVENT_BETRAYAL_12, 12000);
                    break;
