...
void NingerAction_Paladin::Update(uint32 pmDiff)
{
...
bool NingerAction_Paladin::Revive(Player* pmTarget)
{
    if (!me)
    {
        return false;
...
bool NingerAction_Paladin::Cure(Unit* pmTarget)
{
    if (!me)
    {
        return false;
...
bool NingerAction_Paladin::DPS(Unit* pmTarget, bool pmChase, bool pmAOE, bool pmMark, float pmChaseDistanceMin, float pmChaseDistanceMax)
{
    if (!me)
    {
        return false;
...
bool NingerAction_Paladin::DPS_Holy(Unit* pmTarget, bool pmChase, bool pmAOE, bool pmMark, float pmChaseDistanceMin, float pmChaseDistanceMax)
{
    if (!me)
    {
        return false;
...
bool NingerAction_Paladin::DPS_Retribution(Unit* pmTarget, bool pmChase, bool pmAOE, bool pmMark, float pmChaseDistanceMin, float pmChaseDistanceMax)
{
    if (!me)
    {
        return false;
...
bool NingerAction_Paladin::Heal(Unit* pmTarget)
{
...
bool NingerAction_Paladin::Heal_Holy(Unit* pmTarget)
{
    if (!me)
    {
        return false;
...
bool NingerAction_Paladin::Buff(Unit* pmTarget)
{
    if (!me)
    {
        return false;
