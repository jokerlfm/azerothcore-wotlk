...
bool Player::_LoadHomeBind(PreparedQueryResult result)
{
	...
	// accept saved data only for valid position (and non instanceable), and accessable
        // lfm no expansion check for map 
        //if (MapMgr::IsValidMapCoord(m_homebindMapId, m_homebindX, m_homebindY, m_homebindZ) && !bindMapEntry->Instanceable() && GetSession()->Expansion() >= bindMapEntry->Expansion())
        //{
        //    ok = true;
        //}
        //else
        ...
        //    CharacterDatabase.Execute(stmt);
        //}
	if (MapMgr::IsValidMapCoord(m_homebindMapId, m_homebindX, m_homebindY, m_homebindZ) && !bindMapEntry->Instanceable())
	{
            ok = true;
	}
	else 
